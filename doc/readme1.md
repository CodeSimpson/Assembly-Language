...
在这个模式下，每个字符有256种属性，一个字符占两个字节，分别存放字符的ASCII码和属性，在80x25模式下，一屏的内容在显示缓冲区中共占4000个字节，显示缓冲区分为8页，每页4KB，显示器可以显示任意一页的内容。一般情况下，显示第0页的内容，也就是B800H ~ B8F9FH中的4000个字节内容将出现在显示器上
